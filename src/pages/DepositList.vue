<template>
  <div>
    <h2 class="display-4 text-primary"># Deposit list</h2>

    <p>Total: {{ totalDocs }} | Pages: {{ totalPages }}</p>

    <ul class="pagination">
      <li v-if="hasPrevPage" class="page-item">
        <button type="button" class="page-link" @click="depositList(page - 1)">
          Previous
        </button>
      </li>
